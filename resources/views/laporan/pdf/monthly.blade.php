...
<body>
    ...
    <div class="summary">
        <table class="summary-table">
            ...
            <tr>
                ...
                <td>Rp {{ number_format($totalBelumBayar, 0, ',', '.') }}</td>
                <td>Rp {{ number_format($totalSudahBayar, 0, ',', '.') }}</td>
            </tr>
        </table>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="10" style="text-align: center;">Tidak ada data untuk periode ini</td>
            </tr>
            @endforelse
        </tbody>
        <tfoot>
